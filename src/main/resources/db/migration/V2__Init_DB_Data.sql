...
insert into INGREDIENTS (id, name, description, image, ingredient_group_entity_id)
    values (nextval('INGREDIENT_SEQUENCE'), 'Дынный ликер', 'Азиатский тропический ликер производят методом мацерации дынной мякоти в нейтральном спирте с водой. Получившуюся основу фильтруют, доводят до нужной сладости и крепости и разливают в бутылки.', 'melon.jpg', 2);
insert into INGREDIENTS (id, name, description, image, ingredient_group_entity_id)    
...
insert into INGREDIENTS (id, name, description, image, ingredient_group_entity_id)
    values (nextval('INGREDIENT_SEQUENCE'), 'Ликер Драй Оранж', 'Ароматный цитрусовый ликер производят методом мацерации цедры апельсинов лараха в нейтральном спирте с водой. Получившуюся основу фильтруют, смешивают с сахаром и выдерживают в дубовых бочках.', 'dry_orange.jpg', 2);
insert into INGREDIENTS (id, name, description, image, ingredient_group_entity_id)    
	values (nextval('INGREDIENT_SEQUENCE'), 'Персиковый ликер', 'Солнечный фруктовый ликер производят методом дистилляции ферментированного персикового сока с добавлением коньячных спиртов для усиления насыщенного аромата добавленных косточек.', 'peach.jpg', 2);
insert into INGREDIENTS (id, name, description, image, ingredient_group_entity_id)    
...
insert into INGREDIENTS (id, name, description, image, ingredient_group_entity_id)
    values (nextval('INGREDIENT_SEQUENCE'), 'Вишневый ликер', 'Знаменитый ягодный ликер производят методом мацерации вишни разных сортов в нейтральном спирте с водой не менее месяца. Получившуюся основу фильтруют, подслащивают, закрепляют коньячными спиртами и выдерживают в дубовых бочках не менее трех лет.', 'Cherry.jpg', 2);
insert into INGREDIENTS (id, name, description, image, ingredient_group_entity_id)
...
insert into INGREDIENTS (id, name, description, image, ingredient_group_entity_id)
    values (nextval('INGREDIENT_SEQUENCE'), 'Зеленый шартрез', 'Монастырский ликер из Французских Альп производят с 1764 года по секретному рецепту. Около 120 растений и трав подвергают мацерации в нейтральном спирте и несколько раз дистиллируют. Получившуюся основу балансируют сахаром, доводят до нужной крепости и выдерживают в дубовых бочках.', 'chartreuse.jpg', 2);
insert into INGREDIENTS (id, name, description, image, ingredient_group_entity_id)
...
insert into INGREDIENTS (id, name, description, image, ingredient_group_entity_id)
    values (nextval('INGREDIENT_SEQUENCE'), 'Яблочный ликер зеленый', 'Свежий фруктовый ликер производят методом мацерации мякоти зеленых яблок в нейтральном спирте. Получившуюся основу фильтруют, смешивают с сахаром и разбавляют водой до нужной крепости.', 'Sour_Apple.jpg', 2);
insert into INGREDIENTS (id, name, description, image, ingredient_group_entity_id)
...
insert into INGREDIENTS (id, name, description, image, ingredient_group_entity_id)
    values (nextval('INGREDIENT_SEQUENCE'), 'Грейпфрутовый ликер', 'Цитрусовый ликер с горчинкой производят методом мацерации цедры розовых грейпфрутов в нейтральном спирте. Получившуюся основу фильтруют, смешивают с сахаром и разбавляют чистой водой до нужной крепости.', 'Sour_Grapefruit.jpg', 2);
insert into INGREDIENTS (id, name, description, image, ingredient_group_entity_id)
...
insert into INGREDIENTS (id, name, description, image, ingredient_group_entity_id)
    values (nextval('INGREDIENT_SEQUENCE'), 'Ликер личи', 'Производят из мякоти спелых личи, которые смешивают с алкоголем и дают настояться.', 'lychee.jpg', 2);
insert into INGREDIENTS (id, name, description, image, ingredient_group_entity_id)
    values (nextval('INGREDIENT_SEQUENCE'), 'Ликер корицы', 'Немецкий пряный ликер производят методом мацерации корицы в шнапсе. Получившуюся основу фильтруют, смешивают с сахаром и для эффектности добавляют пищевое сусальное золото.', 'cinnamon.jpg', 2);
insert into INGREDIENTS (id, name, description, image, ingredient_group_entity_id)
    values (nextval('INGREDIENT_SEQUENCE'), 'Ликер манго', 'Азиатский тропический ликер производят методом мацерации мякоти спелых манго в нейтральном спирте с водой. Получившуюся основу фильтруют и смешивают с сахаром.', 'mango.jpg', 2);
insert into INGREDIENTS (id, name, description, image, ingredient_group_entity_id)
    values (nextval('INGREDIENT_SEQUENCE'), 'Ежевичный ликер', 'Насыщенный ягодный ликер производят методом мацерации ягод лесной ежевики в нейтральном спирте с водой сроком до двух месяцев. Первый сок без отжима фильтруют и смешивают с сахаром.', 'Blackberry.jpg', 2);
insert into INGREDIENTS (id, name, description, image, ingredient_group_entity_id)
...
insert into INGREDIENTS (id, name, description, image, ingredient_group_entity_id)
    values (nextval('INGREDIENT_SEQUENCE'), 'Яичный ликер', 'Голландский рождественский ликер, произошедший от бразильского алкогольного напитка из авокадо, изготавливают из смеси яичных желтков, сахара, ванили и коньяка.', 'advokaat.jpg', 2);
insert into INGREDIENTS (id, name, description, image, ingredient_group_entity_id)
    values (nextval('INGREDIENT_SEQUENCE'), 'Банановый ликер желтый', 'Кремовый тропический ликер производят методом мацерации мякоти желтых бананов в нейтральном спирте с водой. Получившуюся основу фильтруют, смешивают с сахаром и закрепляют молодыми коньячными спиртами.', 'bananes.jpg', 2);
insert into INGREDIENTS (id, name, description, image, ingredient_group_entity_id)
    values (nextval('INGREDIENT_SEQUENCE'), 'Ликер маракуйи', 'Производят из мякоти спелых плодов маракуйи, апельсинов и грейпфрута, которые смешивают с алкоголем и дают настояться.', 'Passion_Fruit.jpg', 2);
insert into INGREDIENTS (id, name, description, image, ingredient_group_entity_id)
    values (nextval('INGREDIENT_SEQUENCE'), 'Яблочный ликер желтый', 'Свежий фруктовый ликер производят методом мацерации мякоти яблок желтых сортов в нейтральном спирте. Получившуюся основу фильтруют, смешивают с сахаром, доводят до кремовой консистенции и разбавляют водой до нужной крепости.', 'yellow_apple.jpg', 2);
insert into INGREDIENTS (id, name, description, image, ingredient_group_entity_id)
...
insert into INGREDIENTS (id, name, description, image, ingredient_group_entity_id)
    values (nextval('INGREDIENT_SEQUENCE'), 'Ликер голубики', 'Снайперский ягодный ликер производят методом мацерации ягод голубики в нейтральном спирте с водой сроком до двух месяцев. Первый сок без отжима фильтруют и смешивают с сахаром.', 'Blueberry.jpg', 2);
insert into INGREDIENTS (id, name, description, image, ingredient_group_entity_id)
...
insert into INGREDIENTS (id, name, description, image, ingredient_group_entity_id)
    values (nextval('INGREDIENT_SEQUENCE'), 'Малиновый ликер', 'Десертный ягодный ликер производят методом мацерации ягод лесной малины в нейтральном спирте с водой сроком до двух месяцев. Первый сок без отжима фильтруют и смешивают с сахаром.', 'raspberry.jpg', 2);
insert into INGREDIENTS (id, name, description, image, ingredient_group_entity_id)
    values (nextval('INGREDIENT_SEQUENCE'), 'Клубничный ликер', 'Десертный ягодный ликер производят методом мацерации ягод клубники в нейтральном спирте с водой сроком до двух месяцев. Первый сок без отжима фильтруют и смешивают с сахаром.', 'strawberry.jpg', 2);
insert into INGREDIENTS (id, name, description, image, ingredient_group_entity_id)
    values (nextval('INGREDIENT_SEQUENCE'), 'Мандариновый ликер', 'Французский цитрусовый ликер производят методом мацерации цедры мандаринов в выдержанных коньячных спиртах. В получившуюся основу добавляют травы и специи, доводят до нужной сладости, повторно выдерживают и фильтруют.', 'mandarin.jpg', 2);
insert into INGREDIENTS (id, name, description, image, ingredient_group_entity_id)
...
insert into INGREDIENTS (id, name, description, image, ingredient_group_entity_id)
    values (nextval('INGREDIENT_SEQUENCE'), 'Грушевый ликер', 'Средиземноморский фруктовый ликер производят методом мацерации мякоти свежих груш в грушевом дистилляте. Получившуюся основу фильтруют, доводят до нужной сладости и крепости, иногда для эффектной подачи разливают в бутылки с растущими прямо в них грушами.', 'pear.jpg', 2);
insert into INGREDIENTS (id, name, description, image, ingredient_group_entity_id)
